package com.shinkson47.OPEX.backend.errormanagement;
...
/**
 * Generalised internal debugging tool for OPEX contributors, and developers
 * using OPEX.
 *
 ...
 *
 */
public class OPEXDebugger extends JFrame implements OPEXHook {
	private static final long serialVersionUID = 1L;
	private static JPanel contentPane = null;

	/**
	 * OPEXDebugger runs externally to the runtime environment. This method invokes
	 * the OPEX Debbugging application to start.
	 */
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					OPEXDebugger frame = new OPEXDebugger();
	...
	public OPEXDebugger() {
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				// HookUpdater.DeRegisterStatic(OPEXDebugger.class.getSimpleName());
				// Logger.log("[@DDBG]");
			}
		...
		// TODO license check
		// Logger.log("[@DBG] OPEX's internal debugger was opened.");
		...
		JTabbedPane ParentPane = new JTabbedPane(SwingConstants.TOP);
		...
		JLabel lblOPEXVersion = new JLabel("OPEX version: ");
		lblOPEXVersion.setBounds(340, 90, 322, 16);
		EnvironmentPane.add(lblOPEXVersion);
		...
		JButton btnShutdownClientVia = new JButton("Shutdown client via OPEX");
		...
		ParentPane.addTab("OPEX API", null, WindowsPane, null);
	...
	JMenu mnupdwarn = new JMenu("OPEXDebugger is not being updated!");
...
//
	...
	// SECTION OPEX Debugger functions
