...
/**
 * Generalised internal debugging tool for JGEL contributors, and developers
 * using JGEL.
 *
 ...
 *
 */
public class JGELDebugger extends JFrame implements JGELHook {
	private static final long serialVersionUID = 1L;
	private static JPanel contentPane = null;

	/**
	 * JGELDebugger runs externally to the runtime environment. This method invokes
	 * the JGEL Debbugging application to start.
	 */
