...
public class OPEXConsole implements IOPEXRunnable {
	...
	private static List<OPEXConsoleInstruction> instructions = new ArrayList<OPEXConsoleInstruction>();

	/**
	 * @return the instructions
	 */
	public static List<OPEXConsoleInstruction> getInstructions() {
		List<OPEXConsoleInstruction> copy = new ArrayList<OPEXConsoleInstruction>();
...
<<<<<<< HEAD:JGEL/Library/BackEnd/Runtime/Console/JGELConsole.java
...
=======
	 ...
	 * Internal instructions are located in BackEnd.Runtime.Console.Instructions.
	 * 
>>>>>>> master:src/com/shinkson47/OPEX/backend/runtime/console/OPEXConsole.java
	 * @param parser - the instruction parser to add.
	 */
	public static void addInstruction(OPEXConsoleInstruction parser) {
	 ...
	 */
	public static OPEXConsoleInstruction getInstruction(String name) {
		for (OPEXConsoleInstruction inst : instructions) {
...
>>>>>>> master:src/com/shinkson47/OPEX/backend/runtime/console/OPEXConsole.java
	...
	public static void parse(String line) {
		OPEXConsoleInstruction parser = getInstruction(line);
		if (parser == null) {
