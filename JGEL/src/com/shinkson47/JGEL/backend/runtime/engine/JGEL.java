...
public class JGEL implements JGELRunnable {
	...
	public JGEL(JGELGame game) {
		...
		GameSuper = game;
		JGELConsole.internalLog(
				"Valid startup call for JGEL backend framework was issued, starting up. Won't be a jiffy!");
		JGELThreadManager.createThread(this, "JGELRuntimeEnvironment"); // Startup JGEL using the startup routine in
																		// this runnable.
	}
	...
	public void run() {
		...
		JGELConsole.internalLog(
				"Internal Framework startup routine has finished invoking subroutines. Subroutines may still be processing. Executing game payload.");
		try {
