...
<<<<<<< HEAD:JGEL/Library/backend/errormanagement/EMSHelper.java
...
=======
	 * 
	 * @throws OPEXStaticException
>>>>>>> master:src/com/shinkson47/OPEX/backend/errormanagement/EMSHelper.java
	 */
	private EMSHelper() throws OPEXStaticException {
		throw new OPEXStaticException("OPEXEMS cannot be instantiated.");
	}
...
>>>>>>> master:src/com/shinkson47/OPEX/backend/errormanagement/EMSHelper.java
	...
	public static void handleException(Throwable e, Boolean Silent) {
		...
		OPEXLoggerUtils.log(Thread.currentThread().getClass().getSimpleName() + // Create a log of the error.
...
>>>>>>> master:src/com/shinkson47/OPEX/backend/errormanagement/EMSHelper.java
	...
	public static void warn(String s) {
		OPEXLoggerUtils.log("[@Warn] " + Thread.currentThread().getClass().getSimpleName() + " says " + s);
	}
