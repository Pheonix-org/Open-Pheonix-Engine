...
public final class INSTThread implements JGELConsoleInstruction {
	...
	public void parse() {
		...
		case "list":
			...
			break;
		case "kill":
			JGELConsole.Write("[JGELThread] Thread killed: " + JGELThreadManager.forceDisposeThread(
					JGELThreadManager.getThread(JGELConsole.getParamString("Name of thread to kill"))));
