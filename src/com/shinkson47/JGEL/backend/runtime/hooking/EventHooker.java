...
public class EventHooker {
     ...
     */
    public List<JGELRegisteredHook> Hooks = new ArrayList<JGELRegisteredHook>();

    /**
     * Triggers a call of all events registered, using JGELHook.updateEvent().
     *
     ...
     */
    public int registerUpdateHook(JGELHook hook, String name) {
     ...
     * @return
     */
    public JGELRegisteredHook GetHookByName(String name) {
        return null;
    }
     ...
     */
    public JGELRegisteredHook getHookByID(int id) {
        for (JGELRegisteredHook i : Hooks) {
            if (i.ID == id) {
                return i;
            }
